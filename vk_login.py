...
class VKAuth(object):
    def __init__(self, permissions, app_id, api_v, email=None, pswd=None, two_factor_auth=False,
                 security_code=None, auto_access=True):
        """
        @args:
    ...
    def auth(self):
        """
            ...
            3. Retrieves access token and user id
        """
    ...
    def get_token(self):
        """
            @return value:
                ...
                (String) access_token that was retrieved in self.auth() method
        """
    ...
    def get_user_id(self):
        """
            @return value:
                ...
                (String) _user_id that was retrieved in self.auth() method
        """
    ...
    def _parse_form(self):
        ...
        try:
            ...
            print('Unexpected error occurred while looking for <form> element')
            return False
